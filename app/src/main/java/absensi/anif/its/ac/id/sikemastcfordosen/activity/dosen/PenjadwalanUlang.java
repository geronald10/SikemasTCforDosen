...
import absensi.anif.its.ac.id.sikemastcfordosen.model.Perkuliahan;
import absensi.anif.its.ac.id.sikemastcfordosen.model.RuangKelas;
import absensi.anif.its.ac.id.sikemastcfordosen.model.WaktuKelas;
...
public class PenjadwalanUlang extends AppCompatActivity implements
    ...
    private void showJadwalTerpilih() {
        ...
        tvKodePerkuliahan.setText(perkuliahanTerpilih.getKodeMk());
