...
public class PerkuliahanDosenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class PerkuliahanAdapterViewHolderSecondary extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private class PerkuliahanAdapterViewHolderPrimary extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private PerkuliahanAdapterViewHolderPrimary(View itemView) {
            super(itemView);
