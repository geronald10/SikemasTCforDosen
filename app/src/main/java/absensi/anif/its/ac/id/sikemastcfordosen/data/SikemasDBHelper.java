package absensi.anif.its.ac.id.sikemastcfordosen.data;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.DosenEntry;
import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.KehadiranEntry;
import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.KelasEntry;
import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.PerkuliahanEntry;
import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.PertemuanEntry;
import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.PesertaEntry;
import absensi.anif.its.ac.id.sikemastcfordosen.data.SikemasContract.UserEntry;
